...
public class RegistrationEndpoint {
    ...
    public void registerDevice(@Named("regId") String regId, final User user) throws OAuthRequestException {
        if (user == null) {
    ...
    public void unregisterDevice(@Named("regId") String regId, final User user) throws OAuthRequestException {
        if (user == null) {
            throw new OAuthRequestException("User is not authorized");
        }
    ...
    public CollectionResponse<RegistrationRecord> listDevices(@Named("count") int count, final User user)
